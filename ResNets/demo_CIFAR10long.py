...
table.append_row(['ResNet 18', *parameters(resnet18)])
table.append_row(['ResNet 34', *parameters(resnet34)])
table.append_row(['ResNet 50', *parameters(resnet50)])
table.append_row(['ResNet 101', *parameters(resnet101)])
table.append_row(['ResNet 152', *parameters(resnet152)])
if comments: print(table)


# Apply constraint - Parameters constant

small = count_parameters(ResNet18())  # 3:1 vs 6:1
singleModel = ResNet50() if ensemble_type == 'Big' else ResNet101() 
...
if load_trained_models:
    ...
    with open('Results_Single_Models_2.pkl', 'wb') as object_result:
    ...
    with open('Results_Ensemble_Models_2.pkl', 'wb') as object_result:
