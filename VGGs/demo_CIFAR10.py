...
def parameters(model, typ=None):
    def compare_to_simplest(model, typ):
        simplest = count_parameters(vgg9)
...
table.append_row(['VGG9', *parameters(vgg9)])
table.append_row(['VGG11', *parameters(vgg11)])
table.append_row(['VGG13', *parameters(vgg13)])
table.append_row(['VGG16', *parameters(vgg16)])
table.append_row(['VGG19', *parameters(vgg19)])
print(table)


# Apply constraint - Parameters constant

small = count_parameters(VGG('VGG9'))  # 3:1 vs 5:1 vs 7:1
